...
export default class Elysia<const in out BasePath extends string = '', const in out Scoped extends boolean = false, const in out Singleton extends SingletonBase = {
     ...
     * ```
     */
    onError<const Schema extends RouteSchema>(handler: ErrorHandler<Definitions['error'], MergeSchema<Schema, Metadata['schema'] & Ephemeral['schema'] & Volatile['schema']>, {
        decorator: Singleton['decorator'];
        store: Singleton['store'];
        derive: {};
        resolve: {};
    ...
    onError<const Schema extends RouteSchema>(options: {
        as?: LifeCycleType;
    }, handler: ErrorHandler<Definitions['error'], MergeSchema<Schema, Metadata['schema'] & Ephemeral['schema'] & Volatile['schema']>, {
        decorator: Singleton['decorator'];
        store: Singleton['store'];
        derive: {};
        resolve: {};
